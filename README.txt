...
![Stars](https://img.shields.io/github/stars/maryamoah/telegram-leak-monitor?style=for-the-badge)
![Forks](https://img.shields.io/github/forks/maryamoah/telegram-leak-monitor?style=for-the-badge)
...
curl -X POST http://localhost:8001/extract \
  ...
  -d '{"filepath":"/files/test.txt"}'
Test filter
nginx
Copy code
curl -X POST http://localhost:7000/ingest \
  -H "Content-Type: application/json" \
  -d '{"emails":["test@example.edu"]}'
Test n8n webhook
ruby
Copy code
curl -X POST https://your-n8n-domain/webhook/ti-intel \
  -H "Content-Type: application/json" \
  -d '{"matches":["test@example.edu"]}'
Troubleshooting
